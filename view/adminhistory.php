    ...
    <div class="row" style="margin-left: 20px; margin-right: 20px;">
      <div class="col-md-3">
        <div class="list-group">
          ...
          <a href="index.php?a=adminhistory" class="list-group-item active" style="font-size: 15px; font-weight: normal;">
          ...
          <table id="facultyrecords" class="table table-striped table-bordered w-auto" style="width:100%; color: black; font-size: 14px;">
            <thead>
              <tr>
                  ...
                  <td style="text-align: center;"><b>TRAVEL DATE / TIME</b></td>
                ...
                if(is_array($data)){
                    foreach($data as $id => $historyinfo){
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><a href="#" class="btn btn-sm text-success" data-toggle="modal" data-target="#modalHistory<?php echo $id; ?>">VIEW</a> | <a href="?a=mapping&id=<?php echo $historyinfo['code']; ?>" class="btn btn-sm text-success" target="_blank">MAP</a></td>
                        </tr>
