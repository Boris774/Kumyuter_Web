...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" onload="startTime()">
    ...
    <?php
        if (isset($_POST['passengername']) &&
            ...
            $update = $db->update("users-info", $id, [
            "name"     => $passengername,
            "contact"    => $contact,
            "email"    => $email,
            "address"    => $address
            ...
            header('location: index.php?a=adminhome');
            exit();
        }
    ?>
    ...
    <div class="container">
        ...
        <div class="col-md-10">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Update Passenger Info</div>
                <div class="panel-body">
                    <div class="col-sm-12">
                        ...
                        <?php
                            ...
                            $db = new firebaseRDB($databaseURL);
                            $id = $_GET['id'];
                            $retrieve = $db->retrieve("users-info/$id");
                            $data = json_decode($retrieve, 1);
                        ?>
                        <form class="form-signin" action="index.php?a=adminhomeedit" method="POST">
                            <h2 style="color: black;">Passenger Info</h2>
                            <hr style="border-top: 2px dashed red;">

                            <div class="row" style="text-align: left;">
                                <div class="col-md-6">
                                    <label style="color: #000000;">Passenger Name</label>
                                    <input type="text" name="passengername" class="form-control" placeholder="Passenger Name" value="<?php if(isset($_POST['passengername'])) echo $_POST['passengername']; else echo $data['name']; ?>" style="margin-bottom: 30px;" maxlength="80" required />
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row" style="text-align: left;">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="email" class="form-control" placeholder="Email Address" value="<?php if(isset($_POST['email'])) echo $_POST['email']; else echo $data['email']; ?>" style="margin-bottom: 30px;" maxlength="150" required />
                                </div>
                            ...
                            <div class="row" style="text-align: right;">
                                ...
                                <div class="col-md-6" style="margin-top: 10px;">
                                    ...
                                    <input type="submit" class="btn btn-sm btn-success" value="Update Passenger Info">
                                    <a href="index.php?a=adminhome" class="btn btn-sm btn-danger" style="color: white; ">Close</a>
                                </div>
                            </div>
                        </form>
                        <br>
