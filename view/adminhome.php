    ...
    <div class="row" style="margin-left: 20px; margin-right: 20px;">
      <div class="col-md-3">
        <div class="list-group">
          <a href="index.php?a=adminhome" class="list-group-item active" style="font-size: 15px; font-weight: normal;">
      ...
      <div class="col-md-9">
        <div class="row" style="background-color: #f9f9f9; padding-left: 20px; padding-right: 20px;">
          ...
          <h3 style="text-align: center;"><strong>PASSENGERS RECORD</strong></h3><br>
                ...
                if(is_array($data)){
                    foreach($data as $id => $usersinfo){
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;"><?php echo $usersinfo['name']; ?></td>
                            <td style="text-align: center;"><?php echo $usersinfo['contact']; ?></td>
                            <td style="text-align: center;"><?php echo $usersinfo['user']; ?></td>
                            <td style="text-align: center;"><?php echo ucwords(strtolower($usersinfo['status'])); ?></td>
                            <td style="text-align: center;"><a href="?a=adminhomeedit&id=<?php echo $id; ?>" class="btn btn-sm text-primary">EDIT</a>  |  <a href="#" class="btn btn-sm text-success" data-toggle="modal" data-target="#modalPassenger<?php echo $id; ?>">VIEW</a></td>
                        </tr>

                        <div class="modal fade" id="modalPassenger<?php echo $id; ?>">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row" style="margin-left: 20px; margin-right: 20px; margin-top: 20px; margin-bottom: 20px;">
                                            <div class="col-md-12">
                                                <p style="font-style: italic; font-size: 14px;  font-weight: bold;">
                                                    Passenger Usercode:
                                                    <?php
                                                        echo $usersinfo['code'];
                                                    ?>
                                        ...
                                        <div class="row" style="margin-top: 10px; margin-left: 20px; margin-right: 20px;">
                                            ...
                                            <div class="col-md-7"><?php echo $usersinfo['name']; ?></div>
                                        </div>
                                        <div class="row" style="margin-top: 10px; margin-left: 20px; margin-right: 20px;">
                                            <div class="col-md-4">Contact</div>
                                            <div class="col-md-1">-</div>
                                            <div class="col-md-7"><?php echo $usersinfo['contact']; ?></div>
                                        </div>
                                        <div class="row" style="margin-top: 10px; margin-left: 20px; margin-right: 20px;">
                                            <div class="col-md-4">Address</div>
                                            <div class="col-md-1">-</div>
                                            <div class="col-md-7"><?php echo $usersinfo['address']; ?></div>
                                        </div>
                                        <div class="row" style="margin-top: 10px; margin-left: 20px; margin-right: 20px;">
                                            <div class="col-md-4">Email Address</div>
                                            <div class="col-md-1">-</div>
                                            <div class="col-md-7"><?php echo $usersinfo['email']; ?></div>
                                        </div>
                                        <div class="row" style="margin-top: 10px; margin-left: 20px; margin-right: 20px;">
                                            <div class="col-md-4">Role</div>
                                            <div class="col-md-1">-</div>
                                            <div class="col-md-7"><?php echo $usersinfo['role']; ?></div>
                                        </div>
                                        <div class="row" style="margin-top: 10px; margin-left: 20px; margin-right: 20px;">
                                            <div class="col-md-4">Status</div>
                                            <div class="col-md-1">-</div>
                                            <div class="col-md-7"><?php echo ucwords(strtolower($usersinfo['status'])); ?></div>
                                        </div>
                                    </div>
