...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" onload="startTime()">
    ...
    <div class="row" style="margin-left: 20px; margin-right: 20px;">
      <div class="col-md-3">
        <div class="list-group">
          <a href="index.php?a=adminnotifydriver" class="list-group-item" style="font-size: 15px; font-weight: normal;">
            <span class="glyphicon glyphicon-th-list" style="margin-right: 10px;"></span>
            Driver's New Entry
            <?php include("config/config.php"); include("config/firebaseRDB.php"); $db = new firebaseRDB($databaseURL); $data = $db->retrieve("drivers-info"); $data = json_decode($data, 1);
          ...
          <a href="index.php?a=adminnotifyfranchise" class="list-group-item active" style="font-size: 15px; font-weight: normal;">
            <span class="glyphicon glyphicon-th-list" style="margin-right: 10px;"></span>
      ...
      <div class="col-md-9">
        <div class="row" style="background-color: #f9f9f9; padding-left: 20px; padding-right: 20px;">
          ...
          <h3 style="text-align: center;"><strong>VIEW FRANCHISE EXPIRED</strong></h3><br>
          ...
          <table id="facultyrecords" class="table table-bordered w-auto" style="width:100%; color: black; font-size: 14px;">
            <thead>
              <tr>
                  ...
                  <td style="text-align: center;"><b>FRANCHISE EXPIRY</b></td>
              ...
              <?php
                ...
                if(is_array ($data)){
                    foreach($data as $id => $driverinfo){
                        ...
                        if (strtotime(date("Y-m-d")) >= strtotime($driverinfo['franchiseexpiry']) && $driverinfo['fflag'] == '0'){
                            $count = $count + 1;
                        ?>
                        <tr style="background-color: #FFF9A6;">
                            ...
                            <td style="text-align: center;"><?php echo $driverinfo['franchiseexpiry']; ?></td>
                        ...
                        elseif (strtotime(date("Y-m-d")) >= strtotime($driverinfo['franchiseexpiry']) && $driverinfo['fflag'] == '1'){
                            $count = $count + 1;
                        ?>
                        <tr>
                            <td style="text-align: center;"><?php echo $count; ?></td>
    ...
    <script language="JavaScript">
        $("button.view").click(function(){
            ...
            $.ajax({
                url: "index.php?a=admindriverflagf",
                data:{"id":emergencyid},
                type:"post", 
