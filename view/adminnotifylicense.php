...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" onload="startTime()">
    ...
    <div class="row" style="margin-left: 20px; margin-right: 20px;">
      <div class="col-md-3">
        <div class="list-group">
          ...
          <a href="index.php?a=adminnotifylicense" class="list-group-item active" style="font-size: 15px; font-weight: normal;">
            <span class="glyphicon glyphicon-th-list" style="margin-right: 10px;"></span>
      ...
      <div class="col-md-9">
        <div class="row" style="background-color: #f9f9f9; padding-left: 20px; padding-right: 20px;">
          ...
          <h3 style="text-align: center;"><strong>VIEW DRIVER LICENSE EXPIRED</strong></h3><br>
          ...
          <table id="facultyrecords" class="table table-bordered w-auto" style="width:100%; color: black; font-size: 14px;">
            <thead>
              <tr>
                  ...
                  <td style="text-align: center;"><b>DRIVER EXPIRY</b></td>
              ...
              <?php
                ...
                if(is_array ($data)){
                    foreach($data as $id => $driverinfo){
                        ...
                        if (strtotime(date("Y-m-d")) >= strtotime($driverinfo['dlexpiry']) && $driverinfo['dflag'] == '0'){
                            $count = $count + 1;
                        ?>
                        <tr style="background-color: #FFF9A6;">
                            ...
                            <td style="text-align: center;"><?php echo $driverinfo['dlexpiry']; ?></td>
                        ...
                        elseif (strtotime(date("Y-m-d")) >= strtotime($driverinfo['dlexpiry']) && $driverinfo['dflag'] == '1'){
                            $count = $count + 1;
                        ?>
                        <tr>
                            <td style="text-align: center;"><?php echo $count; ?></td>
    ...
    <script language="JavaScript">
        $("button.view").click(function(){
            ...
            $.ajax({
                url: "index.php?a=admindriverflagd",
                data:{"id":emergencyid},
                type:"post", 
