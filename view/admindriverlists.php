    ...
    <div class="row" style="margin-left: 20px; margin-right: 20px;">
      <div class="col-md-3">
        <div class="list-group">
          ...
          <a href="index.php?a=admindriverlists" class="list-group-item active" style="font-size: 15px; font-weight: normal;">
            <span class="glyphicon glyphicon-user" style="margin-right: 10px;"></span>
            Driver Lists
          </a>
      ...
      <div class="col-md-9">
        <div class="row" style="background-color: #f9f9f9; padding-left: 20px; padding-right: 20px;">
          ...
          <h3 style="text-align: center;"><strong>DRIVERS RECORD</strong></h3><br>
          ...
          <table id="facultyrecords" class="table table-striped table-bordered w-auto" style="width:100%; color: black; font-size: 14px;">
            <thead>
              <tr>
                  ...
                  <td style="text-align: center;" width="25%"><b>ACTION</b></td>
              </tr>
            </thead>
            <tbody>
              <?php
                ...
                if(is_array($data)){
                    foreach($data as $id => $driverinfo){
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;"><?php echo $driverinfo['address']; ?></td>
                            <td style="text-align: center;"><a href="?a=admindriveredit&id=<?php echo $id; ?>" class="btn btn-sm text-primary">EDIT</a>  |  <a href="#" class="btn btn-sm text-success" data-toggle="modal" data-target="#modalDriver<?php echo $id; ?>">VIEW</a>
                            <?php
                                if ($driverinfo['status'] == 'PENDING'){
                                    echo '  |  <p class="btn btn-sm text-danger">PENDING</p>'; 
                                }
                                else{
                                    ?>
                                          |  <a href="<?php echo $driverinfo['qrcode']; ?>" class="btn btn-sm text-success" target="_blank">QR</a>
                                    <?php
                                } 
                            ?>
                            </td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="#info<?php echo $id; ?>">Drivers Info</a></li>
                                            <li><a data-toggle="tab" href="#docs<?php echo $id; ?>">Documents</a></li>
                                            <li><a data-toggle="tab" href="#ratings<?php echo $id; ?>">Ratings</a></li>
                                        </ul>

                                        <div class="tab-content">
                                            <div id="info<?php echo $id; ?>" class="tab-pane fade in active">
                                                    ...
                                                    <div class="col-md-12">
                                                        <p style="font-style: bold; font-size: 14px;  font-weight: bold;">
                                                            ...
                                                            <?php
                                                                ...
                                                                ?>
                                                                <div class="row" style="margin-top: 10px; margin-left: 20px; margin-right: 20px;">
                                                                    <div class="col-md-4">Driver QR Code</div>
                                                                    <div class="col-md-1">-</div>
                                                                    <div class="col-md-7"><a href="<?php echo $driverinfo['qrcode']; ?>" download>Download</a></div>
                                                                </div>
                                                                <?php
                                                                } 
                                                            ?>
                                            ...
                                            <div id="docs<?php echo $id; ?>" class="tab-pane fade">
                                                <div class="row" style="margin-left: 20px; margin-right: 20px; margin-top: 20px; margin-bottom: 20px;">
                                                    <?php
                                                        $data = $db->retrieve("drivers-document");
                                                        $data = json_decode($data, 1);
                                                        
                                                        if(is_array($data)){
                                                            foreach($data as $idoc => $docinfo){
                                                                if ($driverinfo['code'] == $docinfo['code']){
                                                                ?>
                                                                <div class="col-md-4">
                                                                    <div class="thumbnail">
                                                                    <a href="<?php echo $docinfo['documents']; ?>" target="_blank">
                                                                        <img src="<?php echo $docinfo['documents']; ?>" alt="Lights" style="width:100%">
                                                                    </a>
                                                                    </div>
                                                                </div>
                                                                <?php
                                            ...
                                            <div id="ratings<?php echo $id; ?>" class="tab-pane fade">
                                                <div class="row" style="margin-left: 20px; margin-right: 20px; margin-top: 20px; margin-bottom: 20px;">
                                                    <?php
                                                        $data = $db->retrieve("rateus");
                                                        $data = json_decode($data, 1);
                                                        
                                                        if(is_array($data)){
                                                            foreach($data as $idrate => $docrate){
                                                                if ($driverinfo['code'] == $docrate['drivercode']){
                                                                ?>
                                                                <div class="col-md-12">
                                                                    <?php
                                                                        ...
                                                                        if(is_array($data)){
                                                                            foreach($data as $iduser => $userinfo){
                                                                                if ($docrate['passengercode'] == $userinfo['code']){
                                                                                ?>
                                                                    ...
                                                                    ?>
                                                                    <h3>Rate: <?php echo $docrate['rate']; ?></h3>
                                                                    <div class="caption">
                                                                        <p><?php echo $docrate['message']; ?></p>
                                                                        <small><?php echo $docrate['datecreated']; ?></small>
                                                                    </div>
                                                                </div>
                                                                <?php
                                                                }
