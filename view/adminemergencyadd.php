        ...
        <div class="col-md-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-sm-12">                        
                        <form class="form-signin" action="index.php?a=adminemergencyadd" method="POST">
                            ...
                            <div class="row" style="text-align: left;">
                                <div class="col-md-7">
                                    ...
                                    <input type="text" name="emergencyname" class="form-control" placeholder="Emergency Name" value="<?php if(isset($_POST['emergencyname'])) echo $_POST['emergencyname']; ?>" style="margin-bottom: 30px;" maxlength="80" required />
                                </div>
                                <div class="col-md-5">
                            ...
                            <div class="row" style="text-align: right;">
                                ...
                                <div class="col-md-6" style="margin-top: 10px;">
                                    <input type="submit" class="btn btn-sm btn-success" value="Add Contact">
