    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="?a=adminuseradd"><span class="glyphicon glyphicon-plus-sign text-success" style="margin-right: 3px;"></span> Add</a></li>
    ...
    <div class="row" style="margin-left: 20px; margin-right: 20px;">
      <div class="col-md-3">
        <div class="list-group">
          ...
          <a href="index.php?a=adminuser" class="list-group-item active" style="font-size: 15px; font-weight: normal;">
            <span class="glyphicon glyphicon-user" style="margin-right: 10px;"></span>
            Users
          </a>
        </div>
      ...
      <div class="col-md-9">
        <div class="row" style="background-color: #f9f9f9; padding-left: 20px; padding-right: 20px;">
          ...
          <h3 style="text-align: center;"><strong>USER LISTS</strong></h3><br>

          <table class="table table-striped table-bordered w-auto" id="users" style="width:100%; color: black; font-size: 14px;">
            <thead>
              <tr>
            ...
            <tbody>
              <?php
                $count = 0;
                $code = $_SESSION['CODE'];
                $sql = mysqli_query($conn,"SELECT * FROM tbl_staff WHERE CODE != '$code' ORDER BY ID DESC");
                if (mysqli_num_rows($sql) > 0) {
                  while ($info = mysqli_fetch_array($sql)){
                    $count = $count + 1;
                    $id = $info['ID'];
                    $staffcode = $info['CODE'];
                    $fullname = $info['LASTNAME'].", ".$info['FIRSTNAME']."  ".substr($info['MIDDLENAME'],0, 1).".";
                    $gender = $info['GENDER'];
                    $role = $info['ROLE'];
                    ...
                    ?>
                      <tr>
                          ...
                          <td style="text-align: center;"><a href="?a=adminuseredit&id=<?php echo $id; ?>" class="btn btn-sm text-primary">EDIT</a></td>
                      </tr>
                    <?php
                  }
                }
