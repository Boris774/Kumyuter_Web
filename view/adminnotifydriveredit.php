            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-sm-12">     
                        ...
                        ?>                   
                        <form class="form-signin" action="index.php?a=adminnotifydriveredit" method="POST">
                            ...
                            <div class="row" style="text-align: right;">
                                ...
                                <div class="col-md-6" style="margin-top: 10px;">
                                    ...
                                    <a href="index.php?a=adminnotifydriver" class="btn btn-sm btn-danger" style="color: white; ">Close</a>
                                </div>
                            </div>
                        </form>
                        <br>
